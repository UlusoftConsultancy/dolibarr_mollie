...
/**
 * \file    test/phpunit/MollieFunctionalTest.php
 * \ingroup mollie
 ...
 * @package Testmollie
 */
class MollieFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/mollie/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mollie/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mollie/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mollie/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('molliewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMollie_MollieTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMollie_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
